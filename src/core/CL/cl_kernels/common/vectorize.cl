                        ...
                        TENSOR3D_DECLARATION(output))
{
    ...
    int vector_linear_idx = *((__global DATA_TYPE_SRC *)src_ptr) * vector_stride_y + id_x * vector_stride_x;
    ...
    *((__global DATA_TYPE_DST *)output_ptr) = *((__global DATA_TYPE_VEC *)vec_ptr);
}
