...
#pragma unroll
        ...
        //  store_partial_##N0##_##PARTIAL_STORE_N0 
            ...
            (
                CONVERT(src[M0 - 1 - _i].v, VEC_DATA_TYPE(DATA_TYPE, N0)),
                0,
                (__global DATA_TYPE *)(dst_ptr + dst_offset_first_element_in_bytes + 0 * sizeof(DATA_TYPE) + (indirect_y[M0 - 1 - _i].v) * dst_stride_y)
            );
        }
    }
    else
