...
__kernel void simple_forward(TENSOR3D_DECLARATION(src1),
                             TENSOR3D_DECLARATION(src2),
                             TENSOR3D_DECLARATION(src3),
                             TENSOR3D_DECLARATION(dst1),
                             TENSOR3D_DECLARATION(dst2),
                             TENSOR3D_DECLARATION(dst3))
{
    ...
    dst2_ptr += dst2_offset_first_element_in_bytes + dst2_linear_idx;
    dst3_ptr += dst3_offset_first_element_in_bytes + dst3_linear_idx;
    
    src1_ptr += src1_offset_first_element_in_bytes + src1_linear_idx;
    src2_ptr += src2_offset_first_element_in_bytes + src2_linear_idx;
    src3_ptr += src3_offset_first_element_in_bytes + src3_linear_idx;

    *((__global DATA_TYPE *)dst1_ptr) = *((__global DATA_TYPE *)src1_ptr);
    *((__global DATA_TYPE *)dst2_ptr) = *((__global DATA_TYPE *)src2_ptr);
    *((__global DATA_TYPE *)dst3_ptr) = *((__global DATA_TYPE *)src3_ptr);
}
