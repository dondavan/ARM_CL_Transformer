#ifndef SRC_CPU_KERNELS_CL_SIMPLEFORWARD1_KERNEL_H
#define SRC_CPU_KERNELS_CL_SIMPLEFORWARD1_KERNEL_H
...
class ClSimpleForward1Kernel : public IClKernel
{
    private:
    ...
    public:
    /* Default Constructor */
    ClSimpleForward1Kernel() = default;
    ARM_COMPUTE_DISALLOW_COPY_ALLOW_MOVE(ClSimpleForward1Kernel);
     ...
     *
     * Similar to ClSimpleForward1Kernel::configure()
     *
     * @return a status
     */
...
#endif /* SRC_CPU_KERNELS_CL_SIMPLEFORWARD1_KERNEL_H */