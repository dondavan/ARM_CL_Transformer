#ifndef SRC_CPU_KERNELS_CL_SIMPLEFORWARD_KERNEL_H
#define SRC_CPU_KERNELS_CL_SIMPLEFORWARD_KERNEL_H
...
class ClSimpleForwardKernel : public IClKernel
{
    private:
    ...
    public:
    /* Default Constructor */
    ClSimpleForwardKernel() = default;
    ARM_COMPUTE_DISALLOW_COPY_ALLOW_MOVE(ClSimpleForwardKernel);
     ...
     *
     * Similar to ClSimpleForwardKernel::configure()
     *
     * @return a status
     */
...
#endif /* SRC_CPU_KERNELS_CL_SIMPLEFORWARD_KERNEL_H */