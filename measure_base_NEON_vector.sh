...
vector='128'
./graph_bert_base_uncased --threads=4 --text=./data/input_text.txt --segment=./data/input_segment.txt --data=./data/${vector}_npy/bert-base-uncased_npy/ --vocabulary=./data/vocab/bert-base-uncased_vocab.txt --raw-output=true
...
mkdir thesis_result/data/${vector}_npy/NEON/
mv measure_output_* thesis_result/data/${vector}_npy/NEON/